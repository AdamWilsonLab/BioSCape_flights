...
This field campaign in the Greater Cape Floristic Region (GCFR) would use NASA's ER-2 aircraft as a platform for the sensors listed below. The ER-2 is a high altitude aircraft that operates at 70,000 ft (~21 km). This simulates the conditions of orbiting satellites which provides an important scaling step for future biodiversity observatory satellites.
...
The AVIRIS-NG is an cross-track imaging spectrometer with a spectral range of 380-2510 nm and sampling resolution of 5nm. It is the replacement to the widely used AVIRIS-Classic.
