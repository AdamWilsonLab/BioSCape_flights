...
d=4430/(5.5/6.5) # 6.5 hour flight coverage in km (minus one hour for takeoff/landing)
d


makeFlight=function(origin=c(18.5,-34),angle=0,x=sw,y=d,scale=1,wgs84=T,projection=wproj){
